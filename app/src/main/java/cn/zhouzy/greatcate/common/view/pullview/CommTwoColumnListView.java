...
public class CommTwoColumnListView extends LinearLayout {
	...
	public CommTwoColumnListView(Context context) {
		this(context, null);
	}

	public CommTwoColumnListView(Context context, AttributeSet attrs,int defStyle) {
	...
	public CommTwoColumnListView(Context context, AttributeSet attrs) {
