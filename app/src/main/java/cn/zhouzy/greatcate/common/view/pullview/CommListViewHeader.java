...
public class CommListViewHeader extends LinearLayout
{
	 ...
	 *            the context
	 */
	public CommListViewHeader(Context context)
	{
		super(context);
		initView(context);
	}
	 ...
	 *            the attrs
	 */
	public CommListViewHeader(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initView(context);
	}
