 ...
 */
public class CommMultiColumnListView extends ScrollView
{
	...
	/** Adapter. */
	private CommMultiColumnListAdapter mAdapter = null;

	/** Adapter改变的监听器. */
	private AdapterDataSetObserver mDataSetObserver;

	/** 已加载的View. */
	private List<CommViewInfo> mItems = null;
	 ...
	 *            the context
	 */
	public CommMultiColumnListView(Context context)
	{
		this(context, null);
	}
	 ...
	 *            the attrs
	 */
	public CommMultiColumnListView(Context context, AttributeSet attrs)
	{
	 ...
	 *            the def style
	 */
	public CommMultiColumnListView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		scrollLayout.addView(thirdColumn, new LinearLayout.LayoutParams(0,
				LayoutParams.WRAP_CONTENT, 1));
		this.addView(scrollLayout, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT));
		mItems = new ArrayList<CommViewInfo>();
	}
	 ...
	 * @return the adapter
	 */
	public CommMultiColumnListAdapter getAdapter()
	{
		return mAdapter;
	}
	 ...
	 *            the new adapter
	 */
	public void setAdapter(CommMultiColumnListAdapter adapter)
	{
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		// LogM.d(AbMultiColumnListView.class, "onLayout");
		if (changed && !loadOnce)
		{
	...
	protected void layoutChildren()
	{
		...
		if (mAdapter != null)
		{
			...
			{
				CommViewInfo viewInfo = mAdapter.getView(i, null, null);
	 ...
	 *            the view info
	 */
	private void findColumnToAdd(CommViewInfo viewInfo)
	{
	...
	{
		CommViewInfo viewInfo = mItems.get(position);
	 ...
	 * the component's <code>addOnScrollListener<code> method. When the onScroll
