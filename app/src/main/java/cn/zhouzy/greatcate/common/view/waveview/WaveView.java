package cn.zhouzy.greatcate.common.view.waveview;
...
public class WaveView extends LinearLayout
{
	...
	public WaveView(Context context, AttributeSet attrs)
	{
		...
		final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs,
				R.styleable.WaveView, R.attr.waveViewStyle, 0);
		mAboveWaveColor = attributes.getColor(R.styleable.WaveView_above_wave_color,
				DEFAULT_ABOVE_WAVE_COLOR);
		mBlowWaveColor = attributes.getColor(R.styleable.WaveView_blow_wave_color,
