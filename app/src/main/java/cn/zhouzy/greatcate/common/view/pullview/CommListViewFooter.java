...
public class CommListViewFooter extends LinearLayout
{
	 ...
	 *            the context
	 */
	public CommListViewFooter(Context context)
	{
		super(context);
		initView(context);
	}
	 ...
	 *            the attrs
	 */
	public CommListViewFooter(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initView(context);
